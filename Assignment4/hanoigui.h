...
/*
 * Sets up the GUI with the given number of disks on peg 0.
 */
void initialize(int numDisks);

/*
 * Performs a move of the top disk from the given start peg
 * to the top of the given end peg.
 * If the peg indexes are invalid, or there is no disk on the start
