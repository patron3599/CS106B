...
/*
// STUDENT TESTS //
STUDENT_TEST("duplicateNegatives, queue of length one with one negative number"){
    Queue<int> q = {-1};
...
STUDENT_TEST("duplicateNegatives, negative numbers at the end of the queue"){
    Queue<int> q = {1, -2};
...
STUDENT_TEST("duplicateNegatives, all negative numbers in the queue"){
    Queue<int> q = {-1, -2, -3, -4};
